...
PYBIND11_MODULE(simpl, m) {
    ...
    py::class_<SimplicialComplex>(m, "SimplicialComplex")
        ...
        .def("UpdateWeight", &SimplicialComplex::UpdateWeight, "node"_a, "weight"_a,
             "Update the weight of a simplex")
        .def("Weights", &SimplicialComplex::Weights, "rank"_a,
             "Get the weights of all nodes at a given rank")
        .def("ThresholdAbove", &SimplicialComplex::ThresholdAbove, "name"_a, "threshold"_a,
        ...
        .def("ThresholdBelow", &SimplicialComplex::ThresholdBelow, "name"_a, "threshold"_a,
             "Threshold the simplicial complex by removing elements on which "
        ...
        .def("GetSimplicesWithDimension", &SimplicialComplex::GetElementsWithRank, "dim"_a,
        ...
        .def("FVector", &SimplicialComplex::FVector, "Get the f-vector of the simplicial complex")
        ...
        .def("BuildDowkerComplex", &SimplicialComplex::BuildFromBinary, "binary"_a,
             "on_column"_a = false,
        ...
        .def_static("CreateCliqueGraph", &SimplicialComplex::CreateCliqueGraph, "g"_a, "k"_a,
                    "method"_a = 0, "threads"_a = 2,
    ...
    py::class_<HyperGraph>(m, "HyperGraph")
        ...
        .def("ThresholdBelow", &HyperGraph::ThresholdBelow, "name"_a, "threshold"_a,
             "Threshold the hypergraph by retaining elements below the given "
             "threshold for the specified function name. The function should be "
             "monotonically non-increasing")
        .def("AddEdge", &HyperGraph::AddEdge, "edge"_a, "Add an hyperedge to the hypergraph")
        ...
        .def("Betweenness", &HyperGraph::Betweenness, "node"_a, "q"_a, "weighted"_a = false,
             ...
             "with rank=q")
        .def("BetweennessAll", &HyperGraph::BetweennessAll, "k"_a, "q"_a, "weighted"_a = false,
        ...
        .def("FVector", &HyperGraph::FVector, "Get the F-vector of the hypergraph")
        .def("Dimension", &HyperGraph::Dimension, "Get the dimension of the hypergraph")
        .def("EulerCharacteristic", &HyperGraph::EulerCharacteristic,
             "Get the Euler characteristic of the hypergraph")

        .def("BuildFromBinary", &HyperGraph::BuildFromBinary, "binary"_a, "on_column"_a = false,
    ...
    py::class_<Graph>(m, "Graph")
        ...
        .def("AddFunction", &Graph::AddFunction, "name"_a, "func"_a,
        ...
        .def("RemoveEdge", &Graph::RemoveEdge, "v"_a, "u"_a, "Remove an edge from the graph")
        ...
        .def("Betweenness", &Graph::Betweenness, "node"_a, "q"_a, "weighted"_a = false,
             "Calculate the betweenness centrality for the given node via nodes "
             "with rank=q")
        .def("BetweennessAll", &Graph::BetweennessAll, "k"_a, "q"_a, "weighted"_a = false,
             "Calculate the betweenness centrality for all nodes with rank=k via "
             "nodes with rank=q")
        ...
        .def("TotalCount", &Graph::TotalCount, "Get the total count of elements in the graph")
        ...
        .def("BuildFromBinary", &Graph::BuildFromBinary, "binary"_a, "on_column"_a = false,
    ...
    py::class_<CombinatorialComplex>(m, "CombinatorialComplex")
        ...
        .def("AddFunction", &CombinatorialComplex::AddFunction, "name"_a, "func"_a,
        ...
        .def("FeaturesMatrix", &CombinatorialComplex::FeaturesMatrix, "dim"_a,
             ...
             "specified dimension")
        .def("UpdateWeight", &CombinatorialComplex::UpdateWeight, "node"_a, "weight"_a,
        ...
        .def("ThresholdBelow", &CombinatorialComplex::ThresholdBelow, "name"_a, "threshold"_a,
        ...
        .def("BuildWithRank", &CombinatorialComplex::BuildWithRank, "elements"_a, "rank"_a,
             "Build the combinatorial complex with the specified rank from the "
             "given elements")
        .def("BoundaryMatrix", &CombinatorialComplex::BoundaryMatrix, "k"_a, "p"_a,
        ...
        .def("Betweenness", &CombinatorialComplex::Betweenness, "node"_a, "q"_a,
             ...
             "Calculate the betweenness centrality for the given node via nodes "
             "with rank=q")
        .def("BetweennessAll", &CombinatorialComplex::BetweennessAll, "k"_a, "q"_a,
             "weighted"_a = false,
             "Calculate the betweenness centrality for all nodes with rank=k via "
             "nodes with rank=q")
        .def("GetEdges", &CombinatorialComplex::GetAll,
             "Get all edges in the combinatorial complex")
        .def("GetElementsWithRank", &CombinatorialComplex::GetElementsWithRank, "rank"_a,
        ...
        .def("BuildFromBinary", &CombinatorialComplex::BuildFromBinary, "binary"_a,
             "on_column"_a = false,
